    ...
    <body>
        ...
        <nav>
            <ul class="btm_list">
                ...
                <li class='btm_list_item'><input type="button" value="새로운 글 작성" onClick="location.href='board_write.php'"/></li>
                <?php
                    foreach($list as $row) {
                    echo "<li class='btm_list_item'><a href=\"board_read.php?topic_id={$row['topic_id']}\">".htmlspecialchars($row['title'])."</a></li>";
                    }
                ?>
            </ul>
            <div class="paging">
