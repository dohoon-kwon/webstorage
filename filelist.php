<?php
    ...
    if($_GET['type'] !== 'trash'){
        ...
        switch($_GET['type']){
            ...
            case 'photo':
                foreach ($files['img'] as $f) {   
                    echo "<li class='img' onclick=\"location.href='pop.php?file=userfile/$id/$f'\" id='$f'><img src='userfile/$id/$f'></img><p>".$f."</p></li>";
                } 
                break;
    ...
    //휴지통인 경우
        ...
        foreach ($files['img'] as $f) {   
            echo "<li class='img' onclick=\"location.href='pop.php?file=userfile/$id\"trash\"/$f'\"><img src='userfile/{$id}trash/$f'></img><p>".$f."</p></li>";
        }
    }
?>