<?php
    ...
    if(!empty($_GET['link'])){
        ...
        $arr = explode("/",$link);
        $dir = '';
        $link_string = "share.php?f=".$_SESSION['share_folder'];
        $var = $link_string.'&link=';
        
        echo "<nav class=\"link\">";
        echo "<a onclick=\"location.href='$link_string'\">공유폴더메인</a>";
        ...
        foreach ($arr as $d){
            ...
            echo "<h2>&nbsp;>&nbsp;</h2>";
            echo "<a onclick=\"location.href='$var$dir'\">$name</a>";
            $dir = $dir.'/';
        }
